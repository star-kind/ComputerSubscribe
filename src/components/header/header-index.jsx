...
class PublicHeader extends Component {
  ...
  render () {
    var content = <div className="total_header">
          ...
          <ol className="address_order_list">
            <div className="out_list_item">
              <div className="outside_item" id="home_address_id">
                <li><Link to={this.state.home_url}>首页</Link></li>
              </div>
              <div className="outside_item">
                <li><Link to={this.state.login_url}>登录</Link></li>
              </div>
              <div className="outside_item">
                <li><Link to={this.state.register_url}>注册</Link></li>
              </div>
            </div>
            <div className="select_options_div">
              <li>
                <label htmlFor="select_opt_item" className="label_address_collects">地址列表</label>
