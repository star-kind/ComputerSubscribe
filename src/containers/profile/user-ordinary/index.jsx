...
import './index.less'
import { store_key, store_token_key } from '@/api/constant-list'
...
export default class ProfileUserOrdinary extends Component {
  ...
  updateProfile = () => {
    ...
    var tokenObj = getValueFromLocal(store_token_key)
  ...
  handleSubmit = (event) => {
    var url = '/api/subscribe/UsersController/modifyInfoByUserAction'
    //阻止默认事件
      ...
      .then((resp) => {
        ...
        if (resp.data.code === 200) {
          ...
          this.setState({
            ...
            mailbox: resp.data.data.mailbox,
          })
          this.cancelRevamp()
        } else {
